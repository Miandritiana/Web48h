  ...
  <style>
	...
	font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen,
		...
		body {
			...
			background: url("https://images.pexels.com/photos/1640770/pexels-photo-1640770.jpeg?auto=compress&cs=tinysrgb&w=1600");
...
<div class="container left-panel-active">
	...
	<div class="container__form container--signin">
		<form action="<?php echo base_url('Login/checkLog'); ?>" class="form" id="form2" method="get">
			<h2 class="form__title">Sign In</h2>
			<input type="text" placeholder="Nom d'utilisateur" class="input" name="nom"/>
			<input type="password" placeholder="Mot de passe" class="input" name="mdp"/>
